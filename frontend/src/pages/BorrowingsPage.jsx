              ...
              {filtered.map((b, i) => {
                ...
                return (
                  <tr key={b.id}>
                    ...
                    <td style={{ color: overdue ? 'var(--color-danger)' : 'inherit', fontWeight: overdue ? 600 : 400 }}>
                      {fmt(b.dueDate) || '—'}
                      {overdue && <span style={{ marginLeft: 6, fontSize: '0.75rem' }}>⚠️ Overdue</span>}
                    </td>
                    <td>
                      {b.returnDate ? (
            ...
            <form onSubmit={handleCreate}>
              <div className="modal-body">
                ...
                <div className="form-group">
                  ...
                  <select id="borrow-member" className="form-control" value={form.memberId}
                    onChange={(e) => setForm((p) => ({ ...p, memberId: e.target.value }))} required>
                ...
                <div className="form-group">
                  ...
                  <select id="borrow-book" className="form-control" value={form.bookId}
                    onChange={(e) => setForm((p) => ({ ...p, bookId: e.target.value }))} required>
                ...
                <div className="form-group">
                  ...
                  <input id="borrow-duedate" type="date" className="form-control" value={form.dueDate}
                    min={today()}
